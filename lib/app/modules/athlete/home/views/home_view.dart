import 'package:fitpall/app/modules/athlete/home/views/widget/judge.dart';
...
class HomeView extends GetView<HomeController> {
  ...
  print('banners: ${controller.banners}');
  print('locations: ${controller.locations}');
  print('judges: ${controller.judges}');
  print('featuredClasses: ${controller.featuredClasses}');
    return Scaffold(
